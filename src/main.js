document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleDownload = () => {
        ...
        if (val === 'Gnerlab2026') {
            ...
            dlLink.href = "./public/downloads/GnerLab_Setup_Oficial_V3.rar";
            dlLink.download = "GnerLab_Setup_Oficial_V3.rar";
            dlLink.click();

            // alert opcional para dar feedback en caso de que la descarga sea silenciosa
            alert("Autenticación exitosa. Iniciando descarga de GnerLab_Setup_Oficial_V3.rar...");
